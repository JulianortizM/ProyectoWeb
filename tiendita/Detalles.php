...
$consulta = "SELECT count(ID_PRODUCTO) FROM `productos` WHERE ID_PRODUCTO = '$id' AND `DISPO_PRODUC`>=1";
$resultado = mysqli_query($conectar,$consulta);
$registros = mysqli_num_rows($resultado);
if($registros>0){

    $consulta1="SELECT `NOMBRE_PRODUC`,`DESCRIPCION_PRODUC`,`PRECIO_PRODUC`,`DESC_PRODUC` FROM `productos` WHERE ID_PRODUCTO='$id' AND `DISPO_PRODUC`>=1 LIMIT 1";
                ...
                <div class="col-md-6 order-md-1">
                    <div id="carouselImages" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                           ...
                           $imagen2=  "img/productos/".$id."/second.jpg";
