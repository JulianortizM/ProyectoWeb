...
$consulta = "SELECT `ID_PRODUCTO`,`NOMBRE_PRODUC`,`DESCRIPCION_PRODUC`,`PRECIO_PRODUC`,`DESC_PRODUC` FROM `productos` WHERE `DISPO_PRODUC`>=1";
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <a href="Detalles.php?id=<?php echo $id ?>"><button class="button">Ver producto</button></a>
